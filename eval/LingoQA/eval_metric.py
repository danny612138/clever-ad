...
@click.command()
@click.option('--predictions_path', type=click.Path(exists=True), help='Path to predictions file.', default="C:/Users/dan12138/Desktop/WiseAD-main/WiseAD-main/result/lingoqa_results.csv")
